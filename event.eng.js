$('#calendar').evoCalendar({
    ...
    calendarEvents: [
      ...
      },
      {
        ...
        date: ["September/12/2025", "September/17/2025"], // Date range
      ...
      },
      {
        ...
        date: ["November/22/2025", "December/01/2025"], // Date range
...

    {
      ...
      date: ["December/01/2025", "December/10/2025"], // Date range
    ...
    },
    {
      ...
      date: ["February/06/2025", "February/11/2025"], // Date range
    ...
    },
    {
      ...
      date: ["April/24/2025", "May/03/2025"], // Date range
...

  {
    ...
    date: ["May/04/2025", "July/08/2025"], // Date range
  ...
  },
  {
    ...
    date: ["November/14/2025", "November/30/2025"], // Date range
...
},
{
  ...
  date: ["April/24/2025", "May/04/2025"], // Date range
...
date: ["May/06/2025", "July/08/2025"], // Date range
description: "UG EvenSem Break", // Event description (optional)
type: "event",
everyYear: false ,
color: "#11fa05" // Event custom color (optional)
