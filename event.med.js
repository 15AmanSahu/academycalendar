$('#calendar').evoCalendar({
    ...
    //   Academic Calander collage wise for UG
    {
        ...
        date: "July/11/2025", // Event date (required)
      ...
      },
      {
        ...
        date: "December/19/2025", // Event date (required)
        type: "event", // Event type (required)
        color: "#66391d",
        everyYear: false // Same event every year (optional)
      },
      {
        ...
        date: ["November/28/2025", "December/07/2025"], // Date range
      ...
      },
      {
        ...
        date: ["September/05/2025", "September/10/2025"], // Date range
      ...
      },
      {
        ...
        date: ["February/o6/2025", "February/12/2025"], // Date range
      ...
      },
      {
        ...
        date: ["April/26/2025", "May/06/2025"], // Date range
      ...
      },
    {
      ...
      date: ["December/08/2025", "December/18/2025"], // Date range
    ...
    },
    {
        ...
        date: ["May/08/2025", "July/8/2025"], // Date range
    ...
    },
    {
      ...
      date: "December/12/2025", // Event date (required)
      type: "event", // Event type (required)
      color: "#66391d",
      everyYear: false // Same event every year (optional)
    },
    {
      ...
      date: ["November/21/2025", "December/03/2025"], // Date range
      description: "UG End Semester Examination of Odd Sem", // Event description (optional)
      type: "event",
      everyYear: false ,
      color: "#eb4034" // Event custom color (optional)
    ...
    },
    {
      ...
      date: ["February/20/2025", "February/25/2025"], // Date range
    ...
    },
    {
      ...
      date: ["may/01/2025", "May/10/2025"], // Date range
      description: "PG End Semester Examination of even Sem", // Event description (optional)
      type: "event",
      everyYear: false ,
      color: "#eb4034" // Event custom color (optional)
    },
    {
      ...
      date: ["December/04/2025", "December/11/2025"], // Date range
    ...
    {
        name: "Vacation Leave even sem",
        date: ["May/10/2025", "July/08/2025"], // Date range
